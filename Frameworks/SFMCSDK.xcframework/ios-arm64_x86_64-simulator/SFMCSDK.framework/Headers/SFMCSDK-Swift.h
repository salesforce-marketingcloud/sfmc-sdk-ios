...
/// returns:
/// ConfigBuilder
- (SFMCSdkConfigBuilder * _Nonnull)setPersonalizationWithConfig:(id <SFMCSdkModuleConfig> _Nonnull)config onCompletion:(void (^ _Nullable)(enum SFMCSdkOperationResult))onCompletion SWIFT_WARN_UNUSED_RESULT;
...
- (void)setLocationEnabled:(BOOL)geoFenceEnabled;
...
/// Push module
/// @see: https://salesforce-marketingcloud.github.io/MarketingCloudSDK-iOS/appledocs/MarketingCloudSdk/9.0/Classes/PushModule.html
...
/// Requests the Mobile Push SDK when it’s operational and safe to use. The provided callback will be invoked with the Mobile Push SDK when it’s ready.
/// All push SDK-related API calls should be made within this function.
/// \param callback A callback that will receive the Mobile Push SDK when it’s operational/ready.
///
